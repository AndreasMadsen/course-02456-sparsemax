...
def timings(regressors, datasets, epochs=1000, iterations=50):
            ...
            with regression as model:
                for iteration_i in range(iterations):
                    ...
                    for epoch in range(epochs):
                        model.update(dataset.inputs, dataset.targets)
...
def main():
    data, col_names, row_names = timings(
        regressors.all_regressors, datasets.all_datasets, epochs=5
    )
